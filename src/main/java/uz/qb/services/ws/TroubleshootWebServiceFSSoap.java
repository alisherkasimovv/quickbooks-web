...
public interface TroubleshootWebServiceFSSoap {
    ...
    @RequestWrapper(localName = "serverVersion", targetNamespace = "http://developer.intuit.com/", className = "uz.qb.services.ws.ServerVersion")
    @ResponseWrapper(localName = "serverVersionResponse", targetNamespace = "http://developer.intuit.com/", className = "uz.qb.services.ws.ServerVersionResponse")
    ...
    @RequestWrapper(localName = "clientVersion", targetNamespace = "http://developer.intuit.com/", className = "uz.qb.services.ws.ClientVersion")
    @ResponseWrapper(localName = "clientVersionResponse", targetNamespace = "http://developer.intuit.com/", className = "uz.qb.services.ws.ClientVersionResponse")
     ...
     * @param strPassword
     * @return
     *     returns uz.qb.services.ws.ArrayOfString
     */
    ...
    @RequestWrapper(localName = "authenticate", targetNamespace = "http://developer.intuit.com/", className = "uz.qb.services.ws.Authenticate")
    @ResponseWrapper(localName = "authenticateResponse", targetNamespace = "http://developer.intuit.com/", className = "uz.qb.services.ws.AuthenticateResponse")
    ...
    @RequestWrapper(localName = "connectionError", targetNamespace = "http://developer.intuit.com/", className = "uz.qb.services.ws.ConnectionError")
    @ResponseWrapper(localName = "connectionErrorResponse", targetNamespace = "http://developer.intuit.com/", className = "uz.qb.services.ws.ConnectionErrorResponse")
    ...
    @RequestWrapper(localName = "sendRequestXML", targetNamespace = "http://developer.intuit.com/", className = "uz.qb.services.ws.SendRequestXML")
    @ResponseWrapper(localName = "sendRequestXMLResponse", targetNamespace = "http://developer.intuit.com/", className = "uz.qb.services.ws.SendRequestXMLResponse")
    ...
    @RequestWrapper(localName = "receiveResponseXML", targetNamespace = "http://developer.intuit.com/", className = "uz.qb.services.ws.ReceiveResponseXML")
    @ResponseWrapper(localName = "receiveResponseXMLResponse", targetNamespace = "http://developer.intuit.com/", className = "uz.qb.services.ws.ReceiveResponseXMLResponse")
    ...
    @RequestWrapper(localName = "getLastError", targetNamespace = "http://developer.intuit.com/", className = "uz.qb.services.ws.GetLastError")
    @ResponseWrapper(localName = "getLastErrorResponse", targetNamespace = "http://developer.intuit.com/", className = "uz.qb.services.ws.GetLastErrorResponse")
    ...
    @RequestWrapper(localName = "closeConnection", targetNamespace = "http://developer.intuit.com/", className = "uz.qb.services.ws.CloseConnection")
    @ResponseWrapper(localName = "closeConnectionResponse", targetNamespace = "http://developer.intuit.com/", className = "uz.qb.services.ws.CloseConnectionResponse")
